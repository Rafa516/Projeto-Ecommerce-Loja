                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <center><a href="/admin/categories/<?php echo $value1["idcategory"]; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/admin/categories/<?php echo $value1["idcategory"]; ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a></center>
                    </td>
                  </tr>
                  <?php } ?>
