...
<section class="content-header">
  <h1>
    Produtos da Marca <?php echo $brand["desbrand"]; ?>

  </h1>
  <ol class="breadcrumb">
    <li><a href="/admin"><i class="fa fa-home"></i> Home</a></li>
    <li><a href="/admin/brands">Marcas</a></li>
    <li class="active"><a href="">Produtos da marca <?php echo $brand["desbrand"]; ?></a></li>
  </ol>
</section>
    ...
    <div class="row">
                ...
                <div class="box-body">
                    <table class="table table-hover table-bordered">
                       <thead style="background-color: #D8D8D8">
                            ...
                            <th ><center>Adicionar produto na marca <?php echo $brand["desbrand"]; ?></center></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <td><center>
                                <a href="/admin/brands/<?php echo $brand["idbrand"]; ?>/products/<?php echo $value1["idproduct"]; ?>/add" class="btn btn-info btn-xs "><i class="fa fa-arrow-right"></i> Adicionar</a>
                            </td>
                            </tr>
                            <?php } ?>
        ...
        <div class="col-md-6">
            <div class="box box-success">
                <div class="box-header with-border">
                <h3 class="box-title">Produtos na Marca <?php echo $brand["desbrand"]; ?></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">
                    <table class="table table-hover table-bordered">
                       <thead style="background-color: #D8D8D8">
                        ...
                        <tbody>
                            ...
                            <td><?php echo $value1["desproduct"]; ?></td>
                            <td>
                               <center><a href="/admin/brands/<?php echo $brand["idbrand"]; ?>/products/<?php echo $value1["idproduct"]; ?>/remove" class="btn btn-danger btn-xs "><i class="fa fa-arrow-left"></i> Remover</a></center>
                            </td>
                            </tr>
                            <?php } ?>
