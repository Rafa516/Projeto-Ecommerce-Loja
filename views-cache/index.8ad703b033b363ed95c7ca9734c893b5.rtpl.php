 ...
 <div class="row">
  	<div class="col-md-12">
  	 <div class="box box-success">
          <section class="content">
              <b><h4><p> Bem vindo <?php echo $user["desperson"]; ?>, ao Painel Administrativo da loja Papelaria e Livraria J.A.</p></h4></b> <br>

              <div class="row">
                <div class="col-sm-2">
                  <div  style=" border-radius:20%;background-color: #5882FA;  max-width: 100%; height: 28rem;padding: 10px"><br>
                ...
                <div class="col-sm-2">
                  <div  style=" border-radius:20%;background-color: #FE2E2E;  max-width: 100%; height: 28rem;padding: 10px"><br>
                ...
                <div class="col-sm-2">
                  <div  style=" border-radius:20%;background-color: #2EFE64;  max-width: 100%; height: 28rem;padding: 10px"><br>
                ...
                <div class="col-sm-2">
                  <div  style=" border-radius:20%;background-color: #FFBF00;  max-width: 100%; height: 28rem;padding: 10px"><br>
                ...
                <div class="col-sm-2">
                  <div  style=" border-radius:20%;background-color: #FF8000;  max-width: 100%; height: 28rem;padding: 10px"><br>
                  <div class="card-header"><center><i  class="fa fa-copyright" style="font-size:  5rem; color:white;" ></i></center></div>
                    <div class="card-body">
                      <center><h2 style=" color:white;font-size:25px"> <b> <?php if( totalbrands() == 0 ){ ?> Nenhuma marca cadastrada<?php }elseif( totalBrands() == 1 ){ ?><?php echo totalBrands(); ?> marca cadsatrada   <?php }else{ ?><?php echo totalBrands(); ?> Marcas cadastradas<?php } ?></b></h2></center>
                      <hr>
